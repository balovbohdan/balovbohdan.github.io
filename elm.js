...
var $author$project$Core$Theme$getTheme = function (colorScheme) {
	switch (colorScheme) {
		case 'dark':
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A3($author$project$Main$getInitialModel, key, url, 'light'),
...
var $author$project$Components$Author$avatar = function (model) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$backgroundColor(model.theme.secondary),
...
var $author$project$Shared$Utils$Css$mixCss = F2(
...
var $author$project$Components$Author$author = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					A2(
						$author$project$Shared$Utils$Css$mixCss,
						_List_fromArray(
							[
			...
			_List_fromArray(
				[
					$author$project$Components$Author$avatar(model),
...
var $author$project$Features$Home$header = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
...
var $author$project$Components$Card$footer = F2(
	function (model, props) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Css$color(model.theme.textSecondary),
...
var $author$project$Components$Card$getCardCss = F2(
	function (model, props) {
		return A2(
			$author$project$Shared$Utils$Css$mixCss,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Css$backgroundColor(model.theme.primary)
						])),
...
var $author$project$Components$Card$card = F2(
	function (model, props) {
		var _v0 = props.to;
		if (_v0 === '') {
			return A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						A2($author$project$Components$Card$getCardCss, model, props))
					]),
				_List_fromArray(
					[
						$author$project$Components$Card$cover(props),
						A2($author$project$Components$Card$footer, model, props)
					]));
		} else {
			return A2(
...
var $author$project$Features$Home$renderPost = F2(
	function (model, data) {
		return A2(
...
var $author$project$Features$Home$renderPosts = F2(
	function (model, data) {
		return A2(
			$elm$core$List$map,
			$author$project$Features$Home$renderPost(model),
			data);
	});
var $rtfeldman$elm_css$Css$spaceBetween = $rtfeldman$elm_css$Css$prop1('space-between');
var $author$project$Features$Home$state = {
	posts: _List_fromArray(
		[
			{coverSrc: 'assets/avatar.jpg', description: 'About Ramda, Haskell, TypeScript, and Elm', id: '1', title: 'Why I decided to learn Elm and drop React'},
			{coverSrc: 'assets/avatar.jpg', description: 'About Ramda, Haskell, TypeScript, and Elm', id: '2', title: 'Why I decided to learn Elm and drop React'},
			{coverSrc: 'assets/avatar.jpg', description: 'About Ramda, Haskell, TypeScript, and Elm', id: '3', title: 'Why I decided to learn Elm and drop React'},
			{coverSrc: 'assets/avatar.jpg', description: 'About Ramda, Haskell, TypeScript, and Elm', id: '4', title: 'Why I decided to learn Elm and drop React'}
		])
};
...
var $author$project$Features$Home$posts = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		A2($author$project$Features$Home$renderPosts, model, $author$project$Features$Home$state.posts));
};
var $author$project$Features$Home$home = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Features$Home$header(model),
				$author$project$Features$Home$posts(model)
			]));
};
var $author$project$Features$Post$post = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Core$App$app = function (model) {
	...
	switch (_v0) {
		case '/':
			return $author$project$Features$Home$home(model);
		case '/post':
			return $author$project$Features$Post$post(model);
		default:
			return $author$project$Features$Home$home(model);
	}
};
var $author$project$Core$Utils$getPageTitle = function (model) {
	var _v0 = model.url.path;
	switch (_v0) {
		case '/':
...
var $author$project$Main$view = function (model) {
	return {
		...
		title: $author$project$Core$Utils$getPageTitle(model)
	};
};
