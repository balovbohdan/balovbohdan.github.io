...
var $author$project$Features$Home$Model$homeFeatureContentDecoder = A2(
...
var $author$project$Features$Home$Model$decodeHomeFeatureContent = function (content) {
	return A2(
		...
		$elm$json$Json$Decode$list($author$project$Features$Home$Model$homeFeatureContentDecoder),
		content);
};
var $author$project$Features$Home$Model$parseHomeFeatureContent = function (content) {
	var _v0 = $author$project$Features$Home$Model$decodeHomeFeatureContent(content);
	if (_v0.$ === 'Ok') {
		var result = _v0.a;
		return result;
	} else {
...
var $author$project$Features$Home$Home$posts = function (model) {
	var postPreviews = $author$project$Features$Home$Model$parseHomeFeatureContent(model.featureData.content);
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Css$width(
										$rtfeldman$elm_css$Css$pct(100)),
										$rtfeldman$elm_css$Css$color(props.model.theme.textSecondryStrong),
										$rtfeldman$elm_css$Css$fontSize(
...
var $author$project$Features$Post$Post$post = function (model) {
	...
	return _Utils_eq(postId, $elm$core$Maybe$Nothing) ? $rtfeldman$elm_css$Html$Styled$text('This post doesn\'t exist... :(') : A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Components$Article$article(
				{content: $author$project$Features$Post$Post$articleContent, model: model})
			]));
};
