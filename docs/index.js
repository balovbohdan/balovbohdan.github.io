...
var $author$project$Core$Theme$themeDark = {
	...
	backgroundSecondary: A3($rtfeldman$elm_css$Css$rgb, 47, 48, 55),
	...
	primaryLight: A3($rtfeldman$elm_css$Css$rgb, 112, 121, 140),
...
var $author$project$Core$Theme$themeLight = {
	...
	backgroundSecondary: A3($rtfeldman$elm_css$Css$rgb, 240, 240, 240),
	...
	primaryLight: A3($rtfeldman$elm_css$Css$rgb, 93, 100, 116),
...
var $author$project$Core$Route$Route$RouteAuthor = {$: 'RouteAuthor'};
var $author$project$Core$Route$Route$RouteBlog = {$: 'RouteBlog'};
...
var $author$project$Core$Route$Utils$parseUrl = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$author$project$Core$Route$Route$RouteBlog,
			$elm$url$Url$Parser$s('blog')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Core$Route$Route$RouteAuthor,
			$elm$url$Url$Parser$s('author')),
...
var $author$project$Features$Author$Model$Query$queryAuthorFeatureContent = function (model) {
...
var $author$project$Features$Blog$Model$Config$config = {
	meta: {step: 1},
	metaNames: {step: 0},
	steps: 2
};
var $author$project$Features$Blog$Model$Query$getPostMetaItemNames = function (model) {
	var data = A2($elm$core$Array$get, 0, model.featureData.content);
	if (data.$ === 'Nothing') {
		return _List_Nil;
	} else {
...
var $author$project$Features$Blog$Model$Query$queryPostsFeatureContent = function (model) {
	var _v0 = model.featureData.step;
	switch (_v0) {
		case 0:
			return A2($author$project$Model$PostMetaItems$Query$queryPostMetaItems, $author$project$Features$Blog$Model$Config$config.metaNames.step, $author$project$Features$Blog$Model$Config$config.steps);
		case 1:
			var metaItemNames = $author$project$Features$Blog$Model$Query$getPostMetaItemNames(model);
			var messages = A2(
				$elm$core$List$map,
				A2($author$project$Model$PostMeta$Query$queryPostMeta, $author$project$Features$Blog$Model$Config$config.meta.step, $author$project$Features$Blog$Model$Config$config.steps),
				metaItemNames);
			return $elm$core$Platform$Cmd$batch(messages);
		default:
			return $elm$core$Platform$Cmd$none;
...
var $author$project$Core$FeatureData$Utils$queryFeatureContent = F2(
	function (model, path) {
		...
		switch (_v0.$) {
			...
			case 'RouteBlog':
				return $author$project$Features$Blog$Model$Query$queryPostsFeatureContent(model);
			case 'RoutePost':
				var id = _v0.a;
				return A2($author$project$Features$Post$Model$Query$queryPostFeatureContent, model, id);
			default:
				return $author$project$Features$Author$Model$Query$queryAuthorFeatureContent(model);
		}
	});
...
var $author$project$Features$Author$Bio$description = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Hello! I\'m Mr. Balov. And this is my humble blog about Software Development. What you can find here?')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$p,
			_List_Nil,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Firstly, thoughts about exotic techs. Such as Elm or ClosureScript. E.g., I\'m developing this blog with Elm. And it gives me an experience I want to document.')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$p,
			_List_Nil,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Secondly, thoughts and recipes about mainstream techs. Such as React and TypeScript. I like React, and it is my main tool for everyday stuff. And TypeScript is a good addon to it.')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$p,
			_List_Nil,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Thirdly, some notes about different topics around Software Development. E.g., I\'m interested in mentoring and team-leading. And my notes may be useful for everyone who wants to grow to Senior level and higher.')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('So, stay connected! I hope, this will be useful for you. And for me, of course! 🤓')
				]))
		]));
			...
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$flexBasis(
						$rtfeldman$elm_css$Css$pct(50)),
						$rtfeldman$elm_css$Css$backgroundColor(model.theme.primaryLight),
						$rtfeldman$elm_css$Css$backgroundImage(
						$rtfeldman$elm_css$Css$url('/assets/author-1.jpg')),
						$rtfeldman$elm_css$Css$backgroundSize($rtfeldman$elm_css$Css$cover),
						$rtfeldman$elm_css$Css$backgroundPosition($rtfeldman$elm_css$Css$top),
						A2(
						$rtfeldman$elm_css$Css$Media$withMedia,
						_List_fromArray(
							[
...
var $author$project$Components$PageSection$footer = function (props) {
	var _v0 = props.footer;
	if (_v0.$ === 'Nothing') {
...
var $author$project$Components$PageSection$header = function (props) {
	return A2(
...
var $author$project$Components$PageSection$pageSection = function (props) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Components$PageSection$header(props),
				props.body,
...
var $author$project$Features$Author$Interests$tileHeader = function (props) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$src(props.iconSrc),
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
					...
					[
						...
						_List_fromArray(
							[
								...
								$rtfeldman$elm_css$Css$color(props.model.theme.textSecondary)
							]))
					]),
				_List_fromArray(
					[
...
var $author$project$Features$Author$Interests$tile = function (props) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$backgroundColor(props.model.theme.backgroundSecondary)
					]))
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Features$Author$Interests$tileHeader(props),
						A2(
						$rtfeldman$elm_css$Html$Styled$p,
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$href(props.href),
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Css$Transitions$color(100)
									]))
							]))
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Explore')
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($rtfeldman$elm_css$Css$property, 'gap', '30px'),
						A2($rtfeldman$elm_css$Css$property, 'grid-template-columns', 'repeat(auto-fit, minmax(300px, 1fr))')
					]))
			]),
		_List_fromArray(
			[
				$author$project$Features$Author$Interests$tile(
				{description: 'This is my everyday tool.', href: '/', iconSrc: '/assets/react.svg', model: model, title: 'React'}),
				$author$project$Features$Author$Interests$tile(
				{description: 'I believe this is the best lang for business apps development. And a good one for applied FP.', href: '/', iconSrc: '/assets/typescript.svg', model: model, title: 'TypeScript'}),
				$author$project$Features$Author$Interests$tile(
				{description: 'I started exploring this tech just for fun! And I\'m still not sure this is a good production lang.', href: '/#/posts/why-i-decided-to-drop-react', iconSrc: '/assets/elm.svg', model: model, title: 'Elm'}),
				$author$project$Features$Author$Interests$tile(
				{description: 'As for me, FP is a good thing for developing reliable apps.', href: '/#/posts/fp-notes-purity-1', iconSrc: '/assets/cpu.svg', model: model, title: 'Functional Programming'}),
				$author$project$Features$Author$Interests$tile(
				{description: 'I\'m not a professional. But this lang looks interesting for me from an experiments perspective.', href: '/', iconSrc: '/assets/haskell.svg', model: model, title: 'Haskell'}),
				$author$project$Features$Author$Interests$tile(
				{description: 'I like reading and writing. Even tried myself at writing a novel! ✍️', href: 'https://medium.com/@balovbohdan', iconSrc: '/assets/typewriter.svg', model: model, title: 'Writing'})
			]));
};
...
var $author$project$Features$Blog$Model$Query$parsePostsFeatureContent = function (content) {
	var posts = A2(
		$elm$core$List$drop,
		1,
...
var $author$project$Features$Blog$Blog$post = F2(
...
var $author$project$Features$Blog$Blog$posts = function (model) {
	var content = $author$project$Features$Blog$Model$Query$parsePostsFeatureContent(model.featureData.content);
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		A2(
			$elm$core$List$map,
			$author$project$Features$Blog$Blog$post(model),
			content));
};
var $author$project$Features$Blog$Blog$blog = function (model) {
	return $author$project$Features$Blog$Blog$posts(model);
};
var $author$project$Features$Home$Author$description = _List_fromArray(
	[
		A2(
		$rtfeldman$elm_css$Html$Styled$p,
		_List_fromArray(
...
var $author$project$Components$Introduction$description = function (props) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
...
var $author$project$Components$Introduction$picture = function (props) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Css$flexBasis(
						$rtfeldman$elm_css$Css$pct(50)),
						$rtfeldman$elm_css$Css$backgroundColor(props.model.theme.primaryLight),
						$rtfeldman$elm_css$Css$backgroundImage(
						$rtfeldman$elm_css$Css$url(props.pictureUrl)),
						$rtfeldman$elm_css$Css$backgroundSize($rtfeldman$elm_css$Css$cover),
						$rtfeldman$elm_css$Css$backgroundPosition($rtfeldman$elm_css$Css$top),
						A2(
						$rtfeldman$elm_css$Css$Media$withMedia,
...
var $author$project$Components$Introduction$introduction = function (props) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Components$Introduction$picture(props),
				$author$project$Components$Introduction$description(props)
			]));
};
var $author$project$Features$Home$Author$body = function (model) {
	return $author$project$Components$Introduction$introduction(
		{description: $author$project$Features$Home$Author$description, model: model, pictureUrl: '/assets/author-1.jpg'});
};
...
var $author$project$Components$Button$button = function (props) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Events$onClick(props.onClick),
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text(props.text)
			]));
};
var $author$project$Features$Home$Author$exploreMoreButton = function (model) {
	return $author$project$Components$Button$button(
		{
			model: model,
			onClick: $author$project$Core$Message$MessageLinkClicked(
				$elm$browser$Browser$External('/#/author')),
			text: 'Explore more'
		});
};
var $author$project$Features$Home$Author$author = function (model) {
	return $author$project$Components$PageSection$pageSection(
		{
			body: $author$project$Features$Home$Author$body(model),
			footer: $elm$core$Maybe$Just(
				$author$project$Features$Home$Author$exploreMoreButton(model)),
			model: model,
			title: 'About author'
		});
};
var $author$project$Features$Home$Constants$constants = {blogPostsLimit: 3};
var $author$project$Features$Home$Posts$getShouldShowGoToBlogButton = function (content) {
	return _Utils_cmp(
		$elm$core$List$length(content),
		$author$project$Features$Home$Constants$constants.blogPostsLimit) > 0;
};
var $author$project$Features$Home$Posts$goToBlogButton = function (model) {
	return $author$project$Components$Button$button(
		{
			model: model,
			onClick: $author$project$Core$Message$MessageLinkClicked(
				$elm$browser$Browser$External('/#/blog')),
			text: 'Go to blog'
		});
};
var $author$project$Features$Home$Posts$footer = F2(
	function (model, content) {
		var shouldShowGoToBlogButton = $author$project$Features$Home$Posts$getShouldShowGoToBlogButton(content);
		return shouldShowGoToBlogButton ? $author$project$Features$Home$Posts$goToBlogButton(model) : A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_Nil);
	});
...
var $author$project$Features$Home$Posts$postTile = F2(
	function (model, postMeta) {
		return $author$project$Components$Card$card(
			{
				coverSrc: postMeta.cover,
...
var $author$project$Features$Home$Posts$postTiles = F2(
	function (model, limitedContent) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				$author$project$Features$Home$Posts$postTile(model),
				limitedContent));
	});
var $author$project$Features$Home$Posts$posts = function (model) {
	...
	return $author$project$Components$PageSection$pageSection(
		{
			body: A2($author$project$Features$Home$Posts$postTiles, model, limitedContent),
			footer: $elm$core$Maybe$Just(
				A2($author$project$Features$Home$Posts$footer, model, content)),
			model: model,
...
var $author$project$Features$Home$Home$home = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Features$Home$Posts$posts(model),
				$author$project$Features$Home$Author$author(model)
			]));
};
...
var $author$project$Utils$Markdown$Middleware$customHtmlInline = function (inline) {
	return A2(
		$pablohirafuji$elm_markdown$Markdown$Inline$defaultHtml,
		$elm$core$Maybe$Just($author$project$Utils$Markdown$Middleware$customHtmlInline),
		inline);
};
...
var $author$project$Utils$Markdown$Middleware$customHtmlBlock = function (block) {
	return A3(
		$pablohirafuji$elm_markdown$Markdown$Block$defaultHtml,
		$elm$core$Maybe$Just($author$project$Utils$Markdown$Middleware$customHtmlBlock),
		$elm$core$Maybe$Just($author$project$Utils$Markdown$Middleware$customHtmlInline),
		block);
};
...
var $author$project$Utils$Markdown$Middleware$markdownMiddleware = function (markdown) {
	return $elm$core$List$concat(
		A2(
			$elm$core$List$map,
			$author$project$Utils$Markdown$Middleware$customHtmlBlock,
			A2($pablohirafuji$elm_markdown$Markdown$Block$parse, $elm$core$Maybe$Nothing, markdown)));
};
var $author$project$Utils$Markdown$Markdown$parseMarkdown = function (markdown) {
	return A2(
		$elm$core$List$map,
		$rtfeldman$elm_css$Html$Styled$fromUnstyled,
		$author$project$Utils$Markdown$Middleware$markdownMiddleware(markdown));
};
...
var $author$project$Components$Article$content = function (props) {
	return A2(
		...
		$author$project$Utils$Markdown$Markdown$parseMarkdown(props.content));
};
...
var $author$project$Core$Route$Utils$getFeature = function (path) {
	...
	switch (_v0.$) {
		...
		case 'RouteBlog':
			return $author$project$Features$Blog$Blog$blog;
		case 'RoutePost':
			return $author$project$Features$Post$Post$post;
		default:
			return $author$project$Features$Author$Author$author;
	}
};
...
var $author$project$Core$Layout$socialButton = F3(
	function (name, socialHref, imageUrl) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$a,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$title(name),
					$rtfeldman$elm_css$Html$Styled$Attributes$href(socialHref)
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Core$Layout$footer = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$color(model.theme.primaryLight)
							]))
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('All rights reserved')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A3($author$project$Core$Layout$socialButton, 'GitHub', 'https://github.com/balovbohdan', 'https://raw.githubusercontent.com/balovbohdan/balovbohdan.github.io/main/docs/assets/github.svg'),
						A3($author$project$Core$Layout$socialButton, 'Twitter', 'https://twitter.com/balov_bohdan', 'https://raw.githubusercontent.com/balovbohdan/balovbohdan.github.io/main/docs/assets/twitter.svg')
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[props.feature])),
				$author$project$Core$Layout$footer(props.model)
			]));
};
